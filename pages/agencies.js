...
export default function Agencies() {
    return (
        <section className="main-content">
            ...
            <table id="table_agencies" className="table table-responsive table-striped table-main bg-white shadow-2">
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="discrepancy">
                            <a href="./view-agency.php" id="btn-view-agency-1" className="" title="View Agency 1">View</a>
                        </td>
                        <td className="status">
